            ...
            <div class="lg:flex lg:justify-around">
                <div class="lg:flex items-center">
                    ...
                    <div class="flex space-x-2">
                        ...
                        <div><button class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">検索する</button></div>
                    </div>
                </div>
                <div class="flex">
                    <div>
                        ...
                        <select id="sort" name="sort" class="mr-4">
                            ...
                            <option value="{{ \Constant::SORT_ORDER['later'] }}" @if(\Request::get('sort')===\Constant::SORT_ORDER['later']) selected @endif>更新の早い順
                            <option value="{{ \Constant::SORT_ORDER['older'] }}" @if(\Request::get('sort')===\Constant::SORT_ORDER['older']) selected @endif>更新の遅い順
                            </option>
                        </select>
                    </div>
                    <div>
                            ...
                            <a href="{{ route('user.items.show',['item' => $product->id ]) }}">
                                <div class="border rounded-md p-2 md:p-4">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <p class="mt-1">{{ number_format($product->price) }} <span class="test-sm test-gray-700">円(税込)</span></p>
                                    </div>
                                </div>
                            </a>
                        </div>
